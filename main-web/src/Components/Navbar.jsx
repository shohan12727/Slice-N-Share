...
// const navLinks = ["Home", "Tournament", "Directory" , "Events", "News", "Contact Us"];
...
//                 className={`relative w-full text-left py-3 text-[0.85rem] font-semibold uppercase tracking-[0.07em] transition-colors duration-200 group
...
//                     ${active === link ? "w-12 opacity-100" : "w-0 opacity-0 group-hover:w-12 group-hover:opacity-100"}`}
//                 />
//               </button>
//             </li>
//           ))}
